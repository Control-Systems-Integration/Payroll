...
df2 = df2[['Employee Name', 'Employee ID', 'Ticket Date', 'Agency', 'Supervisors Name', 'PM Assigned', 'JobNo|Customer|Description', 'Email', 'WTL Approved', 'WTL Start Date', 'WTL End Date']]
...
print(df1[df1.duplicated(['Employee Name', 'Ticket Date', 'JobNo|Customer|Description'])])
print(df2[df2.duplicated(['Employee Name', 'Ticket Date', 'JobNo|Customer|Description'])])
...
# Commented Out BY SB 06/11/2023
# Merge dataframes based on 'Employee name' and 'Ticket Date'
# merged_df = pd.merge(df1, df2, on=['Employee Name', 'Ticket Date'], how='left')

# Above Replaced By SB 06/11/2023
# Merge dataframes based on 'Employee name' and 'Ticket Date', 'JobNo|Customer|Description'
